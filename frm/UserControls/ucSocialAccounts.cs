...
namespace SocialManager.frm.UserControls
{
  public partial class ucSocialAccounts : UserControl
  {
    ...
    private void LoadAllUsers()
    {
      ...
      {
        MessageBox.Show($"L?i khi t?i danh sách ngý?i dùng: {ex.Message}", "Error",
    ...
    private void btnUserDetails_Click(object sender, EventArgs e)
    {
      ...
      {
        MessageBox.Show("Vui l?ng ch?n ngý?i dùng ð? xem chi ti?t.", "Chýa ch?n ngý?i dùng",
    ...
    private void ShowDetailedUserInfo(User user)
    {
      ...
      MessageBox.Show(details, "Chi ti?t h? sõ ngý?i dùng", MessageBoxButtons.OK, MessageBoxIcon.Information);
    }
    ...
    private void btnExportUsers_Click(object sender, EventArgs e)
    {
      ...
      {
        MessageBox.Show($"? L?i khi xu?t danh sách ngý?i dùng:\n{ex.Message}", "L?i xu?t d? li?u",
            MessageBoxButtons.OK, MessageBoxIcon.Error);
      }
    }
    ...
    private void btnRefreshData_Click(object sender, EventArgs e)
    {
      ...
      {
        MessageBox.Show($"? L?i khi làm m?i d? li?u:\n{ex.Message}", "L?i làm m?i",
            MessageBoxButtons.OK, MessageBoxIcon.Error);
      }
    }
