    ...
    public partial class ucSimpleDashboard : UserControl
    {
        ...
        private void InitializeControl()
        {
            ...
            btnPost.Click += (s, e) => {
                ...
                {
                    MessageBox.Show("Please enter post content.", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                MessageBox.Show("Post published successfully!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtContent.Clear();
            };
