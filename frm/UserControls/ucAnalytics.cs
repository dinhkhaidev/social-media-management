  ...
  public partial class ucAnalytics : UserControl
  {
    ...
    private void btnExportReport_Click(object sender, EventArgs e)
    {
      using (SaveFileDialog saveFileDialog = new SaveFileDialog())
      {
        ...
        saveFileDialog.Title = "Xuất báo cáo phân tích";
    ...
    private void btnApplyFilter_Click(object sender, EventArgs e)
    {
      ...
      if (fromDate >= toDate)
      {
        MessageBox.Show("Ngày bắt đầu phải trước ngày kết thúc.", "Lỗi xác thực",
            MessageBoxButtons.OK, MessageBoxIcon.Warning);
        return;
      }

      MessageBox.Show($"Đã áp dụng bộ lọc cho khoảng thời gian: {fromDate:dd/MM/yyyy} to {toDate:dd/MM/yyyy}", "Đã áp dụng bộ lọc",
          MessageBoxButtons.OK, MessageBoxIcon.Information);
