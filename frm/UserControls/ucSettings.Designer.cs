namespace SocialManager.frm.UserControls
{
  partial class ucSettings
  {
    ...
    private void InitializeComponent()
    {
      ...
      chkAutoSchedule.Text = "Bật lịch đăng bài tự động";
      ...
      chkNotifications.Text = "Bật thông báo";
      ...
      lblGeneralTitle.Text = "Cài đặt chung";
      //
      // pnlDataManagement
      //
      ...
      btnRestoreData.Text = "Khôi phục từ bản sao lưu";
      ...
      btnBackupData.Text = "💾 Tạo bản sao lưu";
      ...
      lblDataInfo.Text = "Quản lý dữ liệu ứng dụng với chức năng sao lưu và khôi phục. Nên sao lưu thường xuyên để tránh mất dữ liệu.";
      //
      // lblDataTitle
      //
