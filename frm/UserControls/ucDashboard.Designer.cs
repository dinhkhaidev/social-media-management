namespace SocialManager.frm.UserControls
{
  partial class ucDashboard
  {
    ...
    private void InitializeComponent()
    {
      ...
      btnViewAllActivity.Text = "Xem tất cả hoạt động";
      ...
      lblComposerTitle.Text = "Biểu đồ phân tích";
      ...
      lblInteractionsValue.Location = new Point(858, 39);
