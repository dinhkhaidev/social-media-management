    ...
    private void InitializeUserControls()
    {
      try
      {
        ...
        catch (Exception ex)
        {
          ...
          postsControl = CreateSimpleUserControl("Posts Management", "Tính năng quản lý bài viết đang được phát triển...");
        }
        ...
        catch (Exception ex)
        {
          ...
          analyticsControl = CreateSimpleUserControl("Analytics & Reports", "Tính năng phân tích đang được phát triển...");
        }
        ...
        catch (Exception ex)
        {
          ...
          settingsControl = CreateSimpleUserControl("Settings", "Tính năng cài đặt đang được phát triển...");
        }
        ...
        catch (Exception ex)
        {
          ...
          socialAccountsControl = CreateSimpleUserControl("Social Accounts", "Tính năng tài khoản mạng xã hội đang được phát triển...");
        }
