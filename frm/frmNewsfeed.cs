  ...
  public partial class frmNewsfeed : Form
  {
    ...
    private void OpenDashboard()
    {
      try
      {
        ...
        // Create and load ucDashboard
        var ucDashboard = new UserControls.ucDashboard
        {
          Dock = DockStyle.Fill
        };
        ...
        // Optional: Add back button to return to newsfeed
        var btnBack = new Button
        {
          Text = "← Quay lại Newsfeed",
        ...
        btnBack.Click += (s, e) => LoadNewsfeed();
      ...
      {
        MessageBox.Show($"Lỗi khi mở dashboard: {ex.Message}", 
